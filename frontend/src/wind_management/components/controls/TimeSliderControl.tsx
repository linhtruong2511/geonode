...
export const TimeSliderControl: React.FC = () => {
  const { currentTime, setCurrentTime, isPlayingAnimation, setIsPlayingAnimation } = useWindStore();
    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <input 
          ...
          style={{ width: '100%' }}
        />
        <div style={{ fontSize: '11px', textAlign: 'center', marginTop: '4px', color: '#555' }}>
