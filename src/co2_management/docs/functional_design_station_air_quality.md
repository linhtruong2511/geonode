...
| `api/v1/aq-stations/{id}/import_measurements/` | nested action | POST | Import tệp CSV dữ liệu đo đạc cho trạm này |
...
| `api/v1/aq-stations/download_measurement_template/` | custom action | GET | Tải xuống tệp CSV mẫu nhập dữ liệu đo đạc trạm |
