...
|---|---|---|---|
| `api/v1/aq-stations/` | `AirQualityStationViewSet` | GET, POST, PUT, DELETE | CRUD trạm quan trắc |
...
| `api/v1/aq-stations/map/` | custom action | GET | Dữ liệu GeoJSON cho bản đồ |
| `api/v1/aq-measurements/` | `AirQualityMeasurementViewSet` | GET | Truy vấn dữ liệu đo đạc (toàn bộ trạm) |
...
| `api/v1/aq-statistics/` | `AirQualityStatisticsViewSet` | GET | Thống kê tổng hợp |
...
| `api/v1/aq-imports/` | `AirQualityImportViewSet` | GET, POST | Import dữ liệu & xem lịch sử |
...
```json
{
    ...
    "results": [
        {
            "id": 1,
            "source_id": "29518862280522648049760863667",
            "code": "QN_TNMT_KHIHHA",
            "name": "Quảng Ninh: UBND huyện Hải Hà (KK)",
            "address": "...",
            "latitude": 21.0849,
            "longitude": 107.7036,
            "source_status": 0,
...
```json
{
    ...
    "features": [
        {
            "type": "Feature",
            "geometry": {"type": "Point", "coordinates": [107.7036, 21.0849]},
            "properties": {
                "id": 1,
                "code": "QN_TNMT_KHIHHA",
                "name": "Quảng Ninh: UBND huyện Hải Hà (KK)",
