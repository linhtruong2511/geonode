...
| `api/v1/aq-stations/` | [StationViewSet](file:///D:/Research/Geonode/geonode-project/src/co2_management/api_urls.py#L20) | Quản lý trạm quan trắc không khí, lọc GeoJSON bản đồ, xem thống kê, import đo đạc theo trạm & tải file mẫu đo đạc trạm (`/download_measurement_template/`) |
